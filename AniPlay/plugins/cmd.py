...
async def searchCMD(_, message: Message):
    try:
        ...
        if query == '':
            return await message.reply_text('Give me something to search using /search command {for eg. /search Chainsaw Man}')
